<%@ Control Language="C#" AutoEventWireup="true" CodeFile="slideDeckEmlak.ascx.cs" Inherits="sayfalar_ziyaretciWuc_slideDeckEmlak" %>
<asp:DataList ID="DataList1" runat="server" CellPadding="3" HorizontalAlign="Center"
    RepeatColumns="1" RepeatDirection="Horizontal" BackColor="#DEBA84"
