<%@ Control Language="C#" AutoEventWireup="true" CodeFile="emlakARA_Dinamik.ascx.cs"
    Inherits="sayfalar_ziyaretciWuc_emlakARA_Dinamik" %>

<%@ Register src="emlakGoster_Ozet.ascx" tagname="emlakGoster_Ozet" tagprefix="uc1" %>

<table style="width: 1065px">
    <tr>
        <td>
            <asp:LinkButton ID="lbEvAraDinamik" runat="server" OnClick="lbEvAraDinamik_Click">Emlak Ara</asp:LinkButton>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <asp:CheckBoxList ID="cblOzellikler" runat="server" RepeatColumns="4" RepeatDirection="Horizontal"
                RepeatLayout="Flow">
            </asp:CheckBoxList>
        </td>
    </tr>
    <tr>
        <td>
<asp:DataList ID="dtlistEmlak" runat="server" CellPadding="3" 
    ...
    OnItemCommand="dtlistEmlak_ItemCommand" style="text-align: left">
