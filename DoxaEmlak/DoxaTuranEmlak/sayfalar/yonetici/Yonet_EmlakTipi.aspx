<%@ Page Language="C#" MasterPageFile="~/sayfalar/yonetici/yoneticiPaneli.master" AutoEventWireup="true" CodeFile="Yonet_EmlakTipi.aspx.cs" Inherits="sayfalar_yonetici_Yonet_EmlakTipi" Title="Untitled Page" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table>
                ...
                <tr>
                    <td>
                        Seçilen Emlak Tipi kaç evde kullanılıyor?
                    </td>
                    <td>
