<%@ Page Language="C#" MasterPageFile="~/sayfalar/ziyaretci/ziyaretciPaneli.master"
    AutoEventWireup="true" CodeFile="te_Arsa.aspx.cs" Inherits="sayfalar_ziyaretci_te_Arsa"
    Title="Untitled Page" %>

<%@ Register Src="../ziyaretciWuc/emlakGoster_Ozet.ascx" TagName="emlakGoster_Ozet"
    TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Turan Emlak Oto || 2010 || Arsa</title>
</asp:Content>
    ...
    <div id="header">
        <div id="menu">
            <ul>
                ...
                <li class="active"><a href="te_Arsa.aspx?katId=13" title="Arsa">Arsa</a></li>
