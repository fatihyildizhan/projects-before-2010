<%@ Page Language="C#" MasterPageFile="~/sayfalar/ziyaretci/ziyaretciPaneli.master"
    AutoEventWireup="true" CodeFile="te_Isyeri.aspx.cs" Inherits="sayfalar_ziyaretci_te_Isyeri"
    Title="Untitled Page" %>

<%@ Register Src="../ziyaretciWuc/emlakGoster_Ozet.ascx" TagName="emlakGoster_Ozet"
    TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Turan Emlak Oto || 2010 || İşyeri</title>
</asp:Content>
    ...
    <div id="header">
        <div id="menu">
            <ul>
                ...
                <li class="active"><a href="te_Isyeri.aspx?katId=7" title="Isyeri">İşyeri</a></li>
