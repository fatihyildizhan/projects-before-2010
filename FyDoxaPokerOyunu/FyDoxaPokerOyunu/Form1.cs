...
namespace FyDoxaPokerOyunu
{
    public partial class Form1 : Form
    {
        ...
        private void btnDagit_Click(object sender, EventArgs e)
        {
            ...
            oync3dizi = oyuncu3Kartlar.Split('-');
            oync4dizi = oyuncu4Kartlar.Split('-');
        }
