<%@ Page Language="C#" MasterPageFile="~/sayfalar/yonetici/yoneticiPaneli.master" AutoEventWireup="true" CodeFile="Yonet_OzellikTip.aspx.cs" Inherits="sayfalar_yonetici_Yonet_OzellikTip" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>
        <table>
            ...
            <tr>
                <td>
                    Seçilen Özellik Tipi kaç özellikte kullanılıyor?
                </td>
                <td>
