<%@ Page Language="C#" MasterPageFile="~/sayfalar/ziyaretci/ziyaretciPaneli.master"
    AutoEventWireup="true" CodeFile="te_Konut.aspx.cs" Inherits="sayfalar_ziyaretci_te_Konut"
    Title="Untitled Page" %>

<%@ Register src="../ziyaretciWuc/emlakGoster_Ozet.ascx" tagname="emlakGoster_Ozet" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Turan Emlak Oto || 2010 || Konut</title>
</asp:Content>
    ...
    <div id="header">
        <div id="menu">
            <ul>
                ...
                <li class="active"><a href="te_Konut.aspx?katId=8" title="Konut">Konut</a></li>
